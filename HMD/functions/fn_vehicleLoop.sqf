...
while { APD_HMD_SpeedLoopRunning } do
{
	...
	_vehicle setUserMFDText [26, format ["AGL: %1 %2", _aglValue, _altUnit]];
	_vehicle setUserMFDText [27, format ["MSL: %1 %2", _aslValue, _altUnit]];
	_vehicle setUserMFDText [28, format ["SPD: %1 %2", _speedValue, _speedUnit]];
